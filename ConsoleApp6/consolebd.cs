...
namespace ConsoleApp6
{
    ...
    public class Consolebd
    {
        ...
        {
            Console.WriteLine("╓" + new string('─', 110) + "╖");
            Console.WriteLine("║" + "     2-18 База данных эвакуированных автомобилей: Таблица улиц: название, длина. Таблица штрафных авто-       " + "║");
            Console.WriteLine("║" + "     стоянок: название, адрес, телефон. Таблица актов эвакуации: улица, автостоянка, GPS-координаты, тип      " + "║");
            Console.WriteLine("║" + "     нарушения (стоянка на проезжей части в месте запрета, стояна на тротуаре, стоянка на газоне), номер      " + "║");
            Console.WriteLine("║" + "     автомобиля, тип автомобиля (легковой/грузовой малой тонажности/грузовой большой тонажности).             " + "║");
            Console.WriteLine("║" + new string(' ', 110) + "║");
            Console.WriteLine("║" + new string(' ', 110) + "║");
            Console.WriteLine("║" + "  ╓──────────────────╖       ╓─────────────────────────╖                        ╓─────────────────────────╖   " + "║");
            Console.WriteLine("║" + "  ║  Таблица Улиц    ║       ║   Таблица Автостоянок   ║                        ║ Таблица Актов Эвакуаций ║   " + "║");
            Console.WriteLine("║" + "  ╟──────────────────╢       ╟─────────────────────────╢                        ╟─────────────────────────╢   " + "║");
            Console.WriteLine("║" + "  ║ Название  Улицы  ║       ║ Название  Автостоянки   ║           ╓───────────>║ Ссылка на Автостоянку   ║   " + "║");
            Console.WriteLine("║" + "  ║ Длина     Улицы  ║       ║ Адрес     Автостоянки   ║           ║      ╓────>║ Ссылка на Улицу         ║   " + "║");
            Console.WriteLine("║" + "  ╙──────────────────╜       ║ Телефон   Автостоянки   ║           ║      ║     ║ GPS - координаты        ║   " + "║");
            Console.WriteLine("║" + "          ^                  ╙─────────────────────────╜           ║      ║     ║ Тип нарушения           ║   " + "║");
            Console.WriteLine("║" + "          ║                               ^                        ║      ║     ║ Тип автомобиля          ║   " + "║");
            Console.WriteLine("║" + "          ║                               ║                        ║      ║     ║ Номер автомобиля        ║   " + "║");
            Console.WriteLine("║" + "          ║                               ╙────────────────────────╜      ║     ╙─────────────────────────╜   " + "║");
            Console.WriteLine("║" + "          ╙───────────────────────────────────────────────────────────────╜                                   " + "║");
            Console.WriteLine("║" + "                                                                                                              " + "║");
            Console.WriteLine("║" + new string(' ', 110) + "║");
